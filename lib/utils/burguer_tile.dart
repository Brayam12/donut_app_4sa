      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            //Donut Flavor text 
            Text(burguerFlavor, style: TextStyle(
                  //Tamaño de letras
                  fontSize: 20,
                  //Negritas
                  fontWeight: FontWeight.bold,
            ...
            Text(burguerStore, style: TextStyle(
              fontSize: 16
            ),),
            //Icons 
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: (){
                      double price = double.tryParse(burguerPrice) ?? 0;
                      onAdd(price); 
                    }, 
                    child: Text("Add", 
                      style: TextStyle(
